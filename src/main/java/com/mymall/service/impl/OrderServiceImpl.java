...
public class OrderServiceImpl implements OrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path){
        ...
        String subject = new StringBuilder().append("我的商店扫码支付，订单号：").append(outTradeNo).toString();
        ...
        String body = new StringBuilder().append("订单").append(outTradeNo).append("购买商品一共").append(totalAmount).append("元").toString();
...
//        goodsDetailList.add(goods2);
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList){
        ...
        for (Cart cartItem : cartList){
            ...
            if (Const.ProductStatusEnum.ON_SALE.getCode() != product.getStatus()){
                return ServerResponse.createByErrorMessage("产品");
            }
    ...
    /**
     * 拼装前端需要的订单信息vo,vo里还会有收货信息等,用到了shipping
     * @param order 订单概况
     * @param orderItemList 订单下每个条目的详细信息
     * @return OrderVo
     */
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo){
        ...
        if (order.getStatus() != Const.OrderStatusEnum.NO_PAY.getCode()){
            return ServerResponse.createByErrorMessage("已经付款，无法取消");
        }
